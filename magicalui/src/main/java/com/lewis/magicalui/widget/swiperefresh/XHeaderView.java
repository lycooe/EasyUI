...
public class XHeaderView extends LinearLayout {
    ...
    private void initView(Context context) {
        ...
        mContainer = (LinearLayout) LayoutInflater.from(context).inflate(R.layout.library_pull_vw_header, null);
        addView(mContainer, lp);
        setGravity(Gravity.BOTTOM);


        mHeaderContent = (RelativeLayout) findViewById(R.id.header_content);
