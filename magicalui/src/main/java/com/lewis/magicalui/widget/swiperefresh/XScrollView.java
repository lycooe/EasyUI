...
//    private static final String TAG = "XScrollView";
    ...
    private void initView(Context context) {
        ...
        headerParams.gravity = Gravity.CENTER_HORIZONTAL | Gravity.TOP;
        ...
        LayoutParams footerParams = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        contentParams.gravity = Gravity.CENTER_HORIZONTAL | Gravity.BOTTOM;
        mFooterLayout = new LinearLayout(context);
        mFooterLayout.setOrientation(LinearLayout.VERTICAL);
        mFooterLayout.setLayoutParams(footerParams);
...
//        this.addView(mLayout);
    ...
    private void initWithContext(Context context) {
        ...
        mHeaderContent = new LinearLayout(context);
        mHeaderContent.addView(mHeader);
        mHeaderLayout.addView(mHeaderContent);
