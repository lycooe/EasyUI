package com.lewis.magicalui.widget;
...
import com.lewis.magicalui.activity.LibraryBaseFragment;
import com.lewis.magicalui.util.CheckTool;
import com.lewis.magicalui.util.MagicalLog;
...
public class LibraryTabbar extends FrameLayout {
    ...
    private void setTabWidget() {
        if (tabWidget == null) {
            MagicalLog.e(TAG, "set tab widget error");
            return;
        }
...
//                    mCurrentIndex = index;
    ...
    private void changeView(int page) {
        ...
        try {
            ...
            MagicalLog.e(TAG, "Tabbar change fragment err", e);
        }
    }
